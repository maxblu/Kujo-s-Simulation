...
logging.basicConfig(format='Kojo\'s %(levelname)s system: %(message)s', level=logging.DEBUG)

#Variables del sistema
nA=0
n1=0    #cantidad de gente que quiere sandwish y esta en la tienda 
n2=0    #cantidad de gente que quiere sushi y esta en la tienda
t0=600
t=600 
T=1260
SS=[0]
...
#indicando la disponibilidad o no de un chef para antender el pedido
chef1=False
chef2=False

#variables de salida 
A={} # A[i]  es tiempo de llegada del cliente i
...
def simula_kujos(dias=30):
    ...
    for i in range(0,dias):
        ...
        for i in range(1,nA+1):
            diferences.append(timeInWait[i]-A[i])
    ...
    log(statistics.mean(means))
    log(statistics.mean(eficiencias))
